  ...
  return (
    <>
      ...
      {open &&
        ...
        createPortal(
          <div
            className="fixed inset-0 z-[100] grid place-items-center overflow-y-auto bg-black/25 p-3 backdrop-blur-sm sm:p-6"
            onMouseDown={(event) =>
          ...
          >
            <section
              ...
              className="flex h-[min(88dvh,760px)] w-full max-w-2xl flex-col overflow-hidden rounded-2xl bg-card shadow-2xl ring-1 ring-black/10"
            >
              ...
              {!selected ? (
                <>
                    ...
                    {results.map((card) => (
                      ...
                      >
                        ...
                        <span className="text-sm font-semibold">
                          {formatMoney(
                            card.prices[0]?.marketPriceCents ?? null,
                          )}
                        </span>
                      </button>
                    ))}
                  ...
                  <div className="flex shrink-0 justify-end border-t bg-card p-4 sm:px-5">
                ...
                <form onSubmit={save} className="overflow-y-auto p-5">
                  ...
                  <div className="sticky bottom-0 -mx-5 mt-5 flex justify-end gap-2 border-t bg-card px-5 pb-1 pt-4">
                    <Button type="button" variant="outline" onClick={close}>
                      Cancel
                    </Button>
